                ...
                <div class="col-md-8 col-lg-9 p-b-80">
                    <div class="p-r-45 p-r-0-lg">
                        ...
                        <div class="wrap-pic-w how-pos5-parent">
                            <img src="{{ Storage::url($post->cover_image) }}" alt="IMG-BLOG">
                        ...
                        <div class="p-t-32">
                            ...
                            <span class="flex-w flex-m stext-111 cl2 p-b-19">
                                <span>
                                    <span class="cl4">By</span> {{ $post->author ?? 'Admin' }}  
...
<div class="page-body">
    <div class="post-detail">
        <div class="cover-image">
            @if ($post->cover_image)
                <img src="{{ Storage::url($post->cover_image) }}" alt="Cover Image">
            @endif
        </div>

        <div class="content">
            <p>{!! nl2br(e($post->content)) !!}</p> <!-- Hiển thị nội dung bài viết -->
        </div>
